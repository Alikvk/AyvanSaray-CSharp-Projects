...
namespace FileExplorer
{
    public partial class Form1 : Form
    {
        ...
        private void treeView1_AfterExpand(object sender, TreeViewEventArgs e)
        {
            ...
            e.Node.ImageIndex=2;//Node ile açılırken imagelist üzerinde belirlediğimiz 2. indexe sahip respi açmamızı sağlamaktadır. 
        }
        ...
        void DosyalariDoldur(string path)
        {
            ...
            foreach (FileInfo fiDosya in dosyalar)
            {
                ...
                //Aşağıdaki kısımda uzanti dictionary değişkenimizin içinde var ise 
                // dosya key 
        ...
        {
            e.Node.ImageIndex = 0;//Kapatılan node un resmini tekrar ilk haline çeviriyoruz
        }
