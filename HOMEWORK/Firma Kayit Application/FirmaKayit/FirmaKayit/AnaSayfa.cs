...
namespace FirmaKayit
{
    public partial class AnaSayfa : Form
    {
      ...
      //  static = programın içerisinde sabit olduğunu belirtmek için böyle çalışıyor
       //     daha hızlı çağırılıyor daha fazla yer turulur birden fazla çağırıldığında rami şişirir
        public AnaSayfa()
        {
            InitializeComponent();
        }
        ...
        private void btnKapat_Click(object sender, EventArgs e)
        {
            //this.Close();
            //Close();
            Application.Exit();//Complete Project Close
        }
        ...
        private void brnFirmaGir_Click(object sender, EventArgs e)
        {
            _f.FrmGir();
        }
    }
